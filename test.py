...
ADMIN_ID = int(os.environ.get("ADMIN_ID", "7006516881"))  # Your Telegram ID
...
# ========== /ping (admin only) ==========
@bot.on_message(filters.private & filters.command("ping", prefixes="/") & filters.user(ADMIN_ID))
async def ping_command(client, message: Message):
    await message.reply("🏓 Pong! Bot is responsive.")

# ========== /check (admin only) ==========
@bot.on_message(filters.private & filters.command("check", prefixes="/") & filters.user(ADMIN_ID))
...
# ========== /id ==========
@bot.on_message(filters.private & filters.command("id", prefixes="/"))
